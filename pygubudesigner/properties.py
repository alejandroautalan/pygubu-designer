...
TK_WIDGET_OPTIONS = {
    ...
    'bitmap': {
        'editor': 'dynamic',
        'params': {'mode': 'choice', 'values': ('',) + TK_BITMAPS, 'state': 'readonly'},
    ...
    'buttoncursor': {
        'editor': 'dynamic',
        'params': {'mode': 'choice', 'values': ('',) + TK_CURSORS, 'state': 'readonly'},
        'help': help_for('buttoncursor'),
    },
    'buttondownrelief': {
        'editor': 'dynamic',
        'params': {'mode': 'choice', 'values': ('',) + TK_RELIEFS, 'state': 'readonly'},
    ...
    'compound': {
        ...
        'help': {'tk': help_for('compound-tk'), 'ttk': help_for('compound-ttk')},
    },
    # ttk.Button
    'confine': {
        'editor': 'dynamic',
    ...
    'direction': {
        ...
        'tk.Menubutton': {
            'params': {'values': ('', tk.LEFT, tk.RIGHT, 'above'), 'state': 'readonly'}
        },
        'ttk.Menubutton': {
            'params': {
    ...
    'foreground': {
        'editor': 'dynamic',
        'params': {'mode': 'colorentry'},
        'help': {'tk': help_for('foreground-tk'), 'ttk': help_for('foreground-ttk')},
    },
    # ttk.Spinbox
    'format': {
        'editor': 'dynamic',
    ...
    'highlightcolor': {'editor': 'colorentry', 'help': help_for('highlightcolor')},
    'highlightthickness': {
    ...
    'state': {
        ...
        'tk.Canvas': {
            'params': {'values': ('', tk.NORMAL, tk.DISABLED), 'state': 'readonly'},
        ...
        'tk.Combobox': {'params': {'values': ('', 'readonly'), 'state': 'readonly'}},
        'ttk.Entry': {
            'params': {
                'values': ('', tk.NORMAL, tk.DISABLED, 'readonly'),
                'state': 'readonly',
        ...
        'ttk.Button': {
            'params': {'values': ('', 'normal', 'disabled'), 'state': 'readonly'}
        },
        'ttk.Notebook.Tab': {
            'params': {
    ...
    # ttk.Label
    'text': {'editor': 'dynamic', 'params': {'mode': 'text'}, 'help': help_for('text')},
    # ttk.Label
    'textvariable': {
        'editor': 'dynamic',
        'params': {'mode': 'tkvarentry'},
    ...
    'wrap': {
        ...
        'tk.Text': {
            'params': {'values': ('', tk.CHAR, tk.WORD, tk.NONE), 'state': 'readonly'},
...
CUSTOM_OPTIONS = {
    ...
    'tree_column': {
        'editor': 'dynamic',
        'params': {'mode': 'choice', 'values': ('true', 'false'), 'state': 'readonly'},
        'default': 'false',
...
LAYOUT_OPTIONS = {
    ...
    'side': {
        'editor': 'choice',
        'params': {'values': ('top', 'bottom', 'left', 'right'), 'state': 'readonly'},
        'default': 'top',
        'help': help_for('side-pack'),
    },
    'bordermode': {
        'editor': 'choice',
        'params': {'values': ('', 'inside', 'outside', 'ignore'), 'state': 'readonly'},
        'help': help_for('bordermode-pack'),
    },
    'height': {'editor': 'pixelcoordinateentry', 'help': help_for('height-pack')},
    'relheight': {'editor': 'relativeentry', 'help': help_for('relheight-pack')},
    ...
    'x': {'editor': 'pixelcoordinateentry', 'default': '0', 'help': help_for('x-pack')},
    'y': {'editor': 'pixelcoordinateentry', 'default': '0', 'help': help_for('y-pack')},
    #
    # grid packing properties
    #
    'row': {'editor': 'naturalnumber', 'default': '0', 'help': help_for('row-grid')},
    'column': {
        'editor': 'naturalnumber',
        'default': '0',
        'help': help_for('column-grid'),
    },
    'sticky': {'editor': 'stickyentry', 'params': {}, 'help': help_for('sticky-grid')},
    'rowspan': {'editor': 'naturalnumber', 'help': help_for('rowspan-grid')},
    'columnspan': {'editor': 'naturalnumber', 'help': help_for('columnspan-grid')},
    #
...
PACK_PROPERTIES = ('anchor', 'side', 'expand', 'fill', 'padx', 'pady', 'ipadx', 'ipady')
