...
TK_WIDGET_OPTIONS = {
    ...
    'bitmap': {
        ...
        'params': {
            'mode': 'choice',
            'values': ('',) + TK_BITMAPS, 'state': 'readonly'},
    ...
    'buttoncursor': {
        ...
        'params': {
            'mode': 'choice',
            'values': ('',) + TK_CURSORS, 'state': 'readonly'},
    ...
    'buttondownrelief': {
        ...
        'params': {
            'mode': 'choice',
            'values': ('',) + TK_RELIEFS, 'state': 'readonly'},
